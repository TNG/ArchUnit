...
At the moment, ArchUnit offers extended support for writing tests with JUnit 4, JUnit 5, and JUnit 6.
...
Furthermore, in order to choose specific classes beneath those locations, `ImportOption`﻿s can be
