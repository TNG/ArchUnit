...
import com.tngtech.archunit.testutils.ExpectedJUnit5TestFailures;
...
class ExamplesJUnit5IntegrationTest extends ExamplesIntegrationTestBase<DynamicTest> {
    ...
    protected ExpectedTestFailures<DynamicTest> createExpectedTestFailures(Class<?>... testClasses) {
        return ExpectedJUnit5TestFailures.forTests(testClasses);
    }

    @TestFactory
    Stream<DynamicTest> CodingRulesTest() {
        return CodingRulesTest(com.tngtech.archunit.exampletest.junit5.CodingRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> ControllerRulesTest() {
        return ControllerRulesTest(com.tngtech.archunit.exampletest.junit5.ControllerRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> CyclicDependencyRulesTest() {
        return CyclicDependencyRulesTest(com.tngtech.archunit.exampletest.junit5.CyclicDependencyRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> DaoRulesTest() {
        return DaoRulesTest(com.tngtech.archunit.exampletest.junit5.DaoRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> DependencyRulesTest() {
        return DependencyRulesTest(com.tngtech.archunit.exampletest.junit5.DependencyRulesTest.class);
    }
    ...
    Stream<DynamicTest> InterfaceRulesTest() {
        return InterfaceRulesTest(com.tngtech.archunit.exampletest.junit5.InterfaceRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> LayerDependencyRulesTest() {
        return LayerDependencyRulesTest(com.tngtech.archunit.exampletest.junit5.LayerDependencyRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> LayeredArchitectureTest() {
        return LayeredArchitectureTest(com.tngtech.archunit.exampletest.junit5.LayeredArchitectureTest.class);
    }

    @TestFactory
    Stream<DynamicTest> OnionArchitectureTest() {
        return OnionArchitectureTest(com.tngtech.archunit.exampletest.junit5.OnionArchitectureTest.class);
    }

    @TestFactory
    Stream<DynamicTest> MethodsTest() {
        return MethodsTest(com.tngtech.archunit.exampletest.junit5.MethodsTest.class);
    }

    @TestFactory
    Stream<DynamicTest> ModulesTest() {
        return ModulesTest(com.tngtech.archunit.exampletest.junit5.ModulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> NamingConventionTest() {
        return NamingConventionTest(com.tngtech.archunit.exampletest.junit5.NamingConventionTest.class);
    }

    @TestFactory
    Stream<DynamicTest> PlantUmlArchitectureTest() {
        return PlantUmlArchitectureTest(com.tngtech.archunit.exampletest.junit5.PlantUmlArchitectureTest.class);
    }

    @TestFactory
    Stream<DynamicTest> ProxyRulesTest() {
        return ProxyRulesTest(com.tngtech.archunit.exampletest.junit5.ProxyRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> RestrictNumberOfClassesWithACertainPropertyTest() {
        return RestrictNumberOfClassesWithACertainPropertyTest(com.tngtech.archunit.exampletest.junit5.RestrictNumberOfClassesWithACertainPropertyTest.class);
    }
    ...
    Stream<DynamicTest> SessionBeanRulesTest() {
        return SessionBeanRulesTest(com.tngtech.archunit.exampletest.junit5.SessionBeanRulesTest.class);
    }

    @TestFactory
    Stream<DynamicTest> SingleClassTest() {
        return SingleClassTest(com.tngtech.archunit.exampletest.junit5.SingleClassTest.class);
    }

    @TestFactory
    Stream<DynamicTest> SlicesIsolationTest() {
        return SlicesIsolationTest(com.tngtech.archunit.exampletest.junit5.SlicesIsolationTest.class);
    }

    @TestFactory
    Stream<DynamicTest> ThirdPartyRulesTest() {
        return ThirdPartyRulesTest(com.tngtech.archunit.exampletest.junit5.ThirdPartyRulesTest.class);
    }
}
