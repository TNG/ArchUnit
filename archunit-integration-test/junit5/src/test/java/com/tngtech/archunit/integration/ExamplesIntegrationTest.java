...
class ExamplesIntegrationTest {
    ...
    Stream<DynamicTest> CodingRulesTest() {
        ExpectedTestFailures expectFailures = ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> LayeredArchitectureTest() {
        ...
        ExpectedTestFailures expectedTestFailures = ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> ModulesTest() {
        ExpectedTestFailures expectedFailures = ExpectedJUnit5TestFailures
                .forTests(
