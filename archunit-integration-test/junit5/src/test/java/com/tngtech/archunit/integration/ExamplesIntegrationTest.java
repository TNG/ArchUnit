...
class ExamplesIntegrationTest {
    ...
    Stream<DynamicTest> CodingRulesTest() {
        ExpectedJUnit5TestFailures expectFailures = ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> ControllerRulesTest() {
        return ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> DependencyRulesTest() {
        return ExpectedJUnit5TestFailures
                ...
                .by(callFromConstructor(InheritedControllerImpl.ChildControl.class).toConstructor(AbstractController.AbstractInnerControl.class).inLine(6))
    ...
    Stream<DynamicTest> LayeredArchitectureTest() {
        ...
        ExpectedJUnit5TestFailures expectedTestFailures = ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> OnionArchitectureTest() {
        ...
        ExpectedTestFailures<DynamicTest> expectedTestFailures = ExpectedJUnit5TestFailures
                .forTests(
    ...
    Stream<DynamicTest> ModulesTest() {
        ExpectedTestFailures<DynamicTest> expectedFailures = ExpectedJUnit5TestFailures
                .forTests(
        ...
        BiConsumer<ModuleNames, ExpectedTestFailures<?>> expectRespectTheirDeclaredDependenciesViolations =
                (moduleNames, expected) -> expected
                        ...
                        .by(ExpectedModuleDependency.uncontained(inheritanceFrom(AddressController.class).extending(AbstractController.class)))
                        ...
                        .by(ExpectedModuleDependency.fromModule(moduleNames.catalog()).toModule(moduleNames.order())
                                .including(callFromMethod(ProductCatalog.class, "gonnaDoSomethingIllegalWithOrder")
                                        .toConstructor(Order.class).inLine(12))
                                .including(callFromMethod(ProductCatalog.class, "gonnaDoSomethingIllegalWithOrder")
                                        .toMethod(Order.class, "addProducts", Set.class).inLine(16)))
                        ...
                        .by(ExpectedModuleDependency.fromModule(moduleNames.importer()).toModule(moduleNames.customer())
                                .including(callFromMethod(ProductImport.class, "getCustomer")
                                        .toConstructor(Customer.class).inLine(17))
        ...
        Consumer<ExpectedTestFailures<?>> expectDependOnEachOtherThroughViolations =
                expected -> expected
                        ...
                        .by(callFromMethod(ProductImport.class, "parse", byte[].class).toConstructor(ProductCatalog.class).inLine(21))
