...
import static com.tngtech.archunit.library.metrics.rendering.DiagramSpec.Factory.plantUml;
...
public class ComponentCouplingMetricsTest {
    ...
    public void create_PlantUml_diagram() throws IOException {
        ...
        Files.write(Paths.get("coupling.puml"), couplingMetrics.toDiagram().render(plantUml()).getBytes(UTF_8));
    }
}
