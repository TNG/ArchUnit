...
public class ClassFileImporterAnnotationsTest {
    ...
    void imports_simple_annotation() {
        JavaClass javaClass = new ClassFileImporter().importClass(AnnotationToImport.class);
    ...
    void imports_annotation_defaults() {
        JavaClass annotationType = new ClassFileImporter().importClass(TypeAnnotationWithEnumAndArrayValue.class);
    ...
    class Classes {
        ...
        void imports_class_with_one_annotation_correctly() {
            JavaClass clazz = new ClassFileImporter().importClass(ClassWithOneAnnotation.class);
        ...
        void imports_class_with_complex_annotations_correctly() {
            JavaClass clazz = new ClassFileImporter().importClass(ClassWithComplexAnnotations.class);
        ...
        void imports_class_with_annotation_with_empty_array() {
            JavaClass clazz = new ClassFileImporter().importClass(ClassWithAnnotationWithEmptyArrays.class);
    ...
    class Fields {
        ...
        void imports_fields_with_one_annotation_correctly() throws Exception {
            JavaField field = new ClassFileImporter().importClass(ClassWithAnnotatedFields.class)
                    .getField("stringAnnotatedField");
        ...
        void imports_fields_with_two_annotations_correctly() throws Exception {
            JavaField field = new ClassFileImporter().importClass(ClassWithAnnotatedFields.class)
                    .getField("stringAndIntAnnotatedField");
        ...
        void imports_fields_with_complex_annotations_correctly() throws Exception {
            JavaField field = new ClassFileImporter().importClass(ClassWithAnnotatedFields.class)
                    .getField("enumAndArrayAnnotatedField");
    ...
    class Methods {
        ...
        void imports_methods_with_one_annotation_correctly() throws Exception {
            JavaMethod method = new ClassFileImporter().importClass(ClassWithAnnotatedMethods.class)
                    .getMethod(stringAnnotatedMethod);
        ...
        void imports_methods_with_two_annotations_correctly() throws Exception {
            JavaMethod method = new ClassFileImporter().importClass(ClassWithAnnotatedMethods.class)
                    .getMethod(stringAndIntAnnotatedMethod);
        ...
        void imports_methods_with_complex_annotations_correctly() throws Exception {
            JavaMethod method = new ClassFileImporter().importClass(ClassWithAnnotatedMethods.class)
                    .getMethod(enumAndArrayAnnotatedMethod);
    ...
    class MethodAndConstructorParameters {
        ...
        void imports_empty_parameter_annotations_for_method_without_annotated_parameters() {
            JavaMethod method = new ClassFileImporter().importClass(ClassWithMethodWithAnnotatedParameters.class)
    ...
    class Constructors {
        ...
        void imports_constructors_with_complex_annotations_correctly() throws Exception {
            JavaConstructor constructor = new ClassFileImporter().importClass(ClassWithAnnotatedMethods.class)
                    .getConstructor();
