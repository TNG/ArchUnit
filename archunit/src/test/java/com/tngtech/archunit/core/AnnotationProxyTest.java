...
public class AnnotationProxyTest {
    ...
    private ImmutableMap<String, String> propertiesOf(Class<TestAnnotation> type) {
        ...
        ImmutableMap<String, String> result = ImmutableMap.<String, String>builder()
                ...
                .put("subAnnotation",
                        "@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=custom)")
                .put("subAnnotationWithDefault",
                        "@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=default)")
                .put("subAnnotations",
                        "[@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=customOne), " +
                                "@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=customTwo)]")
                .put("subAnnotationsWithDefault",
                        "[@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=defaultOne), " +
                                "@com.tngtech.archunit.core.AnnotationProxyTest$SubAnnotation(value=defaultTwo)]")
                .build();
