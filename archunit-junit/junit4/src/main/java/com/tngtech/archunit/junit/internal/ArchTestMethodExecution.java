...
class ArchTestMethodExecution extends ArchTestExecution {
    ...
    ArchTestMethodExecution(List<Class<?>> testClassBranch, Class<?> ruleDeclaringClass, Method testMethod, boolean ignore) {
        super(testClassBranch, ruleDeclaringClass, ignore);
