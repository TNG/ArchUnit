...
final class ArchUnitRunnerInternal extends ParentRunner<ArchTestExecution> implements ArchUnitRunner.InternalRunner<ArchTestExecution> {
    ...
    private static class ExecutionTransformer implements ArchRuleDeclaration.Handler {
        ...
        @Override
        public void handleFieldDeclaration(List<Class<?>> testClassBranch, Field field, Class<?> fieldOwner, boolean ignore) {
            executions.add(new ArchRuleExecution(testClassBranch, fieldOwner, field, ignore));
        }

        @Override
        public void handleMethodDeclaration(List<Class<?>> testClassBranch, Method method, Class<?> methodOwner, boolean ignore) {
            executions.add(new ArchTestMethodExecution(testClassBranch, methodOwner, method, ignore));
        }
