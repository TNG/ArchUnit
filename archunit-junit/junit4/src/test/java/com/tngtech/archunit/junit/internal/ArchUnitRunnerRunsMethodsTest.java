...
import static com.tngtech.archunit.junit.internal.ArchUnitRunnerRunsMethodsTest.ArchTestWithIgnoredMethod.toBeIgnored;
import static com.tngtech.archunit.junit.internal.ArchUnitRunnerRunsMethodsTest.ArchTestWithIllegalTestMethods.noParams;
import static com.tngtech.archunit.junit.internal.ArchUnitRunnerRunsMethodsTest.ArchTestWithIllegalTestMethods.tooManyParams;
import static com.tngtech.archunit.junit.internal.ArchUnitRunnerRunsMethodsTest.ArchTestWithTestMethod.privateTest;
...
public class ArchUnitRunnerRunsMethodsTest {
    ...
    @InjectMocks
    private ArchUnitRunnerInternal runner = newRunnerFor(ArchTestWithTestMethod.class);
    ...
    public void ignores_all_methods_in_classes_annotated_with_ArchIgnore() throws InitializationError {
        ArchUnitRunnerInternal runner = new ArchUnitRunnerInternal(IgnoredArchTest.class);
    ...
    public void should_pass_annotations_of_test_method() {
        ArchUnitRunnerInternal runner = newRunnerFor(ArchTestWithMethodWithAdditionalAnnotation.class, cache);
    ...
    public void underscores_in_method_name_are_replaced_with_blanks_if_property_is_set_to_true() {
        ArchUnitRunnerInternal runner = newRunnerFor(ArchTestWithMethodWithUnderscoresInName.class, cache);
    ...
    private ArchUnitRunnerInternal newRunner(Class<ArchTestWithIllegalTestMethods> testClass) {
        return newRunnerFor(testClass, cache);
    }

    private void runAndAssertWrongParametersForChild(String name, ArchUnitRunnerInternal runner) {
